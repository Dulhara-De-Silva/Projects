                ...
                <div class="dropdown">
                    ...
                    <div class="report_dropdown-content">
                        ...
                        <div class="dropdown-report-submenu">
                            ...
                            <div class="report_dropdown-subcontent">
                                <div id="yield">Crop Yield and Water Allocation</div>
                            </div>
                        </div>
                        <div class="dropdown-report-submenu">
            ...
            <div class="overview">
                <div class="boxes">
                    <div class="box box1">
                        ...
                        <span class="number">
                            <?php
                                ...
                                $details = $connection->query("SELECT today_water_level,water_inflow,water_evaporation FROM details WHERE date = '$stringdate'");
                                while($row = $details->fetch_assoc()){                                                       
                                    $current_water_level = $row["today_water_level"] + $row["water_inflow"] - $row["water_evaporation"];
                    ...
                    <div class="box box2">
                        ...
                        <span class="text">Water Issue RB Canal</span>
                        <span class="number">
                    ...
                    <div class="box box3">
                        <i class="uil uil-water"></i>
                        <span class="text">Water Issue LB Canal</span>
                        <span class="number">
                            <?php
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                        ...
                        $joined_table = $connection->query("INSERT INTO joined_table SELECT DATE(c.start_date),c.issue,d.water_inflow FROM chart_table AS c JOIN details AS d ON c.start_date = d.date ");   
